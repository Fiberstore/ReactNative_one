...
class MyText extends Component {
    ...
    componentDidMount() {
        ...
        /*NetUtils.get('https://www.baidu.com/','',function (set) {
         //下面是请求下来的数据
         //console.log(set)
         })*/
        /* try {
         fetch('https://www.baidu.com/').then((response) =>  ToastAndroid.show(response.json, ToastAndroid.SHORT));
         }catch (error){
         console.error(error);
         }*/
...
export default class App extends Component<{}> {
    render() {
        ...
        /* <SectionList sections={[{title: 'D', data: ['Devin']},
         ...
         renderItem={({item}) => <Text style={styles.welcome}>{item}</Text>}
        ...
        /* <View style={styles.container}>
         {/!*    <TextInput placeholder={'请输入文字'} onChangeText={
